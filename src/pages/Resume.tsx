      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 mt-12">
        <div className="max-w-5xl mx-auto p-3">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 mb-8 border border-gray-200 dark:border-gray-700">
            <div className="text-center mb-6">
              ...
              <div className="grid   grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm sm:text-base">
                <div className="flex  mid:items-center items-center justify-center space-x-2">
              ...
              {experiences.map((exp, index) => (
                <div key={index} className="relative">
                  ...
                  <div className="flex items-start space-x-4">
                    <div
                      className={`w-12 h-12 bg-gradient-to-br ${getExperienceColor(
                        exp.type
          ...
          <div className="text-center mt-8">
            <button className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
